...
class AnimasiController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->hasFile('photo')) {
            $deleteFile(storage_path("app/public/". $animasi->photo));
            $deleteFile(env("BACKUP_PHOTOS") . $animasi->photo); // Lokasi kedua (backup)
            ...
            $animasi->photo = $sourcePath;
        }
        if ($request->hasFile('photo_kaprog')) {
            $deleteFile(storage_path("app/public/". $animasi->photo_kaprog));
            $deleteFile(env("BACKUP_PHOTOS") . $animasi->photo_kaprog); // Lokasi kedua (backup)
            ...
            $animasi->photo_kaprog = $sourcePath;
