<li>
    <button id="dropdownNavbarLink" data-dropdown-toggle="{{$data}}" class="flex items-center justify-between bg-transparent w-full py-2 px-3 text-gray-700 hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent">{{$slot}}</button>
    <!-- Dropdown menu -->
