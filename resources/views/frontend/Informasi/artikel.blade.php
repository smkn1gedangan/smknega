           ...
           <div class="md:pl-12 mt-20 md:mt-0 p-2 md:py-6 flex flex-wrap gap-3 flex-col sm:flex-row lg:flex-col w-full lg:w-2/3 ">
            ...
            <form method="GET" action="{{ url()->current() }}" class="w-full max-w-md mx-auto my-4">
                ...
                <div class="relative">
                    ...
                    <input   value="{{ request()->input('search') }}" type="search" name="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Cari Artikel" />
