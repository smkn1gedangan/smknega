   ...
   <div class="flex justify-center pt-20 md:pt-28">
    ...
    <div class="w-full flex md:justify-center flex-wrap">
        <div class="flex flex-col w-full p-4 md:w-4/5 md:items-center md:p-8 lg:w-3/5">
            ...
            <p class="mb-3 w-full text-xs md:text-base text-left font-normal text-gray-800 dark:text-gray-400 mt-6">ditulis oleh {{$potensi->penulis->name}}  {{$potensi->created_at->diffForHumans()}}</p>
    </div>
