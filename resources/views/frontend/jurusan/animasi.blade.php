...
<section class="w-full flex justify-center flex-wrap pt-32">
    ...
    <div class="flex flex-col w-full p-2 sm:w-5/6 md:items-center md:p-8  lg:w-3/5">
            ...
            <p class="mb-3 w-full text-xs md:text-base text-left font-normal text-gray-800 dark:text-gray-400 mt-2">ditulis oleh {{$animasi->penulis->name}}  {{$animasi->created_at->diffForHumans()}}</p>
    </div>
