    ...
    <div class="flex flex-col w-full p-2 sm:w-5/6 md:items-center md:p-8  lg:w-3/5">
        <div class="w-full flex flex-wrap justify-center gap-2 ">
            ...
            <div class="flex flex-col justify-center mx-4">
                <h1 class="text-base text-center font-semibold mt-6 text-gray-800 dark:text-gray-100 capitalize">{{$busana->nama_kaprog}}</h1>
                <p class="text-center">sebagai</p>
                <h1 class="text-base text-center font-semibold mb-2 text-gray-800 dark:text-gray-100 capitalize">{{$busana->ket_kaprog}}</h1>
            </div>
        </div>
