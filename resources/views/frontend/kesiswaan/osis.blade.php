...
<section class="w-full flex flex-col md:justify-center flex-wrap">
    ...
    <div class="w-full flex md:justify-center flex-wrap">
        <div class="flex flex-col w-full p-2 md:w-4/5 md:items-center md:p-8 lg:w-3/5">
            ...
            <p data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" class="mb-3 w-full text-xs md:text-base text-left md:text-center font-normal text-gray-800 dark:text-gray-400 mt-2">ditulis oleh {{$osis->penulis->name}}  {{$osis->created_at->diffForHumans()}}</p>
            <p data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" class="mb-3 w-full text-xs md:text-base md:text-center text-left font-normal text-gray-800 dark:text-gray-400 mt-2">ditulis oleh {{$osis->penulis->name}}  {{$osis->created_at->diffForHumans()}}</p>
    </div>
