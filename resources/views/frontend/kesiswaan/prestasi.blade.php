...
@section("title","Prestasi Siswa Smkn 1 Gedangan")
        ...
        <div class="flex flex-col w-full p-2 md:w-4/5 md:items-center md:p-8 md:mt-6 lg:w-3/5">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                   ...
                   <tr data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" class="bg-white dark:bg-gray-800">
