    ...
    <div data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form action="{{ route("save_masukan") }}" method="POST" class="space-y-8">
            ...
            <div>
                ...
                <input data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" type="email" name="email" value="@auth
                    {{ Auth::user()->email }}
            ...
            <div>
                ...
                <input data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" type="text" name="nama" id="subject" value="{{ old("nama") }}" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="nama" required autocomplete="name">
                    @error("nama")
                        <p class="mt-2 text-sm text-red-800">
                            {{ $message }}
                        </p>
            ...
            <div class="sm:col-span-2">
                ...
                <textarea data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" id="masukan" name="masukan" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="biarkan kami mengetahui bug anda..">{{ old("masukan") }}</textarea>
                @error("masukan")
                <p class="mt-2 text-sm text-red-800">
                    {{ $message }}
                </p>
            ...
            @error('g-recaptcha-response')
                <script>alert("captcha wajib di centang")</script>
            @enderror
