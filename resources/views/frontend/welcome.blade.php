            ...
            <div class="flex flex-col w-full gap-2 md:gap-10 ">
                ...
                <div class="flex flex-col relative items-center  bg-white border border-gray-200 rounded-lg shadow md:flex-row  dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 w-[100%] ">
                    ...
                    <div class="w-full  flex flex-col justify-between p-4 leading-normal ">
                        <a href="{{route("readArticle",$article->slug)}}" class="mb-2 text-xl font-semibold tracking-tight text-gray-900 dark:text-white hover:text-slate-600">{{ $article->title }}</a>
                        <p class="mb-3 w-full text-sm md:text-base font-normal text-gray-700 dark:text-gray-400">
