    ...
    <section  id="profil" class="pt-10">
        <div class="w-screen md:max-w-[95%] md:gap-6 p-2 md:pl-10 flex md:flex-row justify-evenly flex-wrap">
            ...
            <div class="flex flex-col md:flex-row-reverse lg:flex-col items-center w-full md:w-full  lg:w-[35%]">
                <div data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" class="w-full md:mt-20 md:w-[38%] lg:w-full max-w-sm bg-white min-h-[40rem] max-h-[42rem] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-8">
                    <div class="relative">
                    ...
                    <div class="w-4/5 md:w-full relative left-1/2 -translate-x-1/2 md:pl-1">
                        ...
                        <a href="{{ route("sambutan_kepsek") }}" class="inline-flex transition-all duration-200 items-center px-3 py-2 text-sm font-medium text-center text-white bg-black rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Read more
