...
@section("content")
    <div id="main" class="main-content flex-1 bg-gray-100 md:pt-20 md:pl-6 md:mt-2">
        <x-title-create-dashboard class="lowercase">edit pemetaan kelulusan</x-title-create-dashboard>
        <div class="w-full">
            <form id="form" action="{{ route('pemetaan.update',[Crypt::encrypt($pemetaan->id)]) }}" class="mt-4 w-full flex flex-col" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                ...
                <img class="w-1/5  duration-700  rounded-md object-cover h-full" src="{{ asset("img/pemetaan/" . $pemetaan->photo) }}" alt="">
                @else
                <p class="mt-3">Photo saat ini : </p>
