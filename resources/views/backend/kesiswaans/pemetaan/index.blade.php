    ...
    <div id="main" class="main-content flex-1 bg-gray-100 md:pt-20 md:pl-6 md:mt-2">
        <div class="flex w-full justify-between items-center pt-4 ">
            <div class="w-3/4 ml-10">
                ...
                <p class="mb-3 text-gray-800 dark:text-gray-400">data pemetaan kelulusan Smkn 1 Gedangan</p>
            </div>
        ...
        <div class="my-5 w-3/4 pl-10">
           ...
           <h1 class="text-2xl mt-6 mb-2 text-gray-800 dark:text-gray-100">{{$pemetaan->nama}}</h1>
            ...
            <div class="items-center ml-6 pb-6">
                ...
                <a href="{{ route('pemetaan.edit', [Crypt::encrypt($pemetaan->id)]) }}" class="bg-yellow-600 hover:bg-orange-400 dark:text-blue-400 ml-4 text-white py-2.5 px-4 rounded-md">Edit data pemetaan</a>
            </div>
        </div>
@endsection
