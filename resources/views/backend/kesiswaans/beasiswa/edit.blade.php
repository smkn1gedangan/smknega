...
@section("content")
    <div id="main" class="main-content flex-1 ">
        <x-titlepage title="data beasiswa" quote="ubah data beasiswa smkn 1 gedangan " isRoute="true" nameRoute="Back" href="{{ route('beasiswa.index') }}"></x-titlepage>
        <div class="w-full p-5">
            <form id="form" action="{{ route('beasiswa.update',[Crypt::encrypt($beasiswa->id)]) }}" class="mt-4 w-full flex flex-col" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
