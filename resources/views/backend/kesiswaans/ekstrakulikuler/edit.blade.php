...
@section("content")
    <div id="main" class="main-content flex-1 ">
        <x-titlepage title="data Ekstrakulikuler" quote="ubah data Ekstrakulikuler yang ada di smkn 1 gedangan " isRoute="true" nameRoute="Back" href="{{ route('ekstrakulikuler.index') }}"></x-titlepage>
