    ...
    <div class="bg-gray-800 shadow-xl h-20 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-56 content-center">
        ...
        <div class="md:mt-12 md:w-56 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
            <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
              ...
              <li class="mr-3 flex-1">
                <button id="profilDropdown" data-dropdown-toggle="jurusan" data-dropdown-placement="right" class="me-3 mt-6 mb-3 md:mb-0 text-white  focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center" type="button">JURUSAN
                </button>
