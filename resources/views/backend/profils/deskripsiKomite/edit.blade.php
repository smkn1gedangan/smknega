...
@section("content")
    <div id="main" class="main-content flex-1 ">
        <x-titlepage title="data Deskripsi Komite" quote="ubah data Deskripsi Komite smkn 1 gedangan " isRoute="true" nameRoute="Back" href="{{ route('deskripsiKomite.index') }}"></x-titlepage>
