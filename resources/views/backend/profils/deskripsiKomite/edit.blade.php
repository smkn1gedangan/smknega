...
@section("content")
    <div id="main" class="main-content flex-1 bg-gray-100 md:pt-20 md:pl-6 md:mt-2">
        <x-title-create-dashboard class="lowercase">edit deskripsi komite</x-title-create-dashboard>
        <div class="w-full">
            <form id="form" action="{{ route('deskripsiKomite.update',[Crypt::encrypt($deskripsiKomite->id)]) }}" class="mt-4 w-full flex flex-col" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4 w-11/12">
                    ...
                    <div id="editor" class="mt-1 shadow-md block w-full px-3 py-2 border border-gray-300 bg-white rounded-md text-gray-700 dark:bg-gray-800 dark:text-gray-200 focus:border-blue-500 focus:outline-none" style="height: 300px;">
                        {!! old('konten', $deskripsiKomite->konten) !!}
