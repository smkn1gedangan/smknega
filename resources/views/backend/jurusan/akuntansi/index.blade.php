        ...
        <div class="my-5 w-3/4 pl-10">
           ...
           <h1 class="text-2xl mt-6 mb-2 text-gray-800 dark:text-gray-100">{{$akuntansi->nama}}</h1>
            ...
            <div class="items-center ml-6 pb-6">
                ...
                <a href="{{ route('akuntansi.edit', [Crypt::encrypt($akuntansi->id)]) }}" class="bg-yellow-600 hover:bg-orange-400 dark:text-blue-400 ml-4 text-white py-2.5 px-4 rounded-md">Edit Data Jurusan akuntansi</a>
            </div>
        </div>
@endsection
