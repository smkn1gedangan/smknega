        ...
        <div class="w-full">
            <form id="form" action="{{ route('akuntansi.update',[Crypt::encrypt($akuntansi->id)]) }}" class="mt-4 w-full flex flex-col" method="POST" enctype="multipart/form-data">
                ...
                <div class="w-11/12 mt-4 mb-8">
                    <button type="submit"
                            class="inline-block px-6 py-2 text-white bg-yellow-500 rounded-lg shadow hover:bg-yellow-600 focus:bg-yellow-500 focus:outline-none">
                        Ubah Jurusan Akuntansi
                    </button>
                </div>
            </form>
        </div>
