...
@section("content")
    <div id="main" class="main-content flex-1">
       <x-titlepage title="data jurusan animasi" quote="ubah data jurusan animasi di smkn 1 gedangan " isRoute="true" nameRoute="Kembali" href="{{ route('animasi.index') }}"></x-titlepage>
                    ...
                    <div class="grid grid-cols-12 space-y-5 gap-2">
                        <div class="col-span-7 ">
                            <div>
                                ...
                                <x-text-input type="text" id="judul" class="block mt-1 w-full" name="judul" :value="old('judul',$animasi->judul)" required  />
                        ...
                        <div class="col-span-7">
                            <div>
                                ...
                                <x-text-input type="text" id="nama_kaprog" class="block mt-1 w-full" name="nama_kaprog" :value="old('nama_kaprog',$animasi->nama_kaprog)" required  />
                        ...
                        <div class="col-span-7">
                            <div>
                                ...
                                <x-text-input type="text" id="ket_kaprog" class="block mt-1 w-full" name="ket_kaprog" :value="old('ket_kaprog',$animasi->ket_kaprog)" required  />
                        ...
                        <div class="col-span-7">
                            <div>
                                ...
                                <x-text-input type="file" id="photo_kaprog" class="block border border-black mt-1 w-full" name="photo_kaprog" :value="old('photo_kaprog',$animasi->photo_kaprog)"  />
                                ...
                                <img class="w-72 h-auto" src="{{ asset("storage/" . $animasi->photo_kaprog) }}" alt="">
                                @else
                                <p class="mt-3">photo kaprog saat ini : </p>
                        ...
                        <div class="col-span-10">
                         ...
                         <div class="col-span-7">
                            <div>
                                ...
                                <x-text-input type="file" id="photo" class="block mt-1 w-full border border-black" name="photo" :value="old('photo',$animasi->photo)"/>
                                <x-input-error :messages="$errors->get('photo')" class="mt-2" />
                                @if (file_exists(public_path('storage/' . $animasi->photo)) && $animasi->photo)
                                <p class="mt-3">photo Jurusan: </p>
                                <img class="w-72 h-auto" src="{{ asset("storage/" . $animasi->photo) }}" alt="">
                                @else
                                <p class="mt-3">photo Jurusan: </p>
                                <div class="bg-gray-200 w-44 h-52 grid place-content-center">
                                <span>No Image</span> <!-- Pesan fallback -->
