                    ...
                    <div class="flex gap-2">
                        ...
                        <div class="w-1/2 gap-2 ">
                            <div class="mb-4 w-4/5">
                                ...
                                <input type="text" value="{{ $animasi->nama_kaprog }}" name="nama_kaprog" id="nama_kaprog"
                                    class="mt-1 shadow-md block w-full px-3 py-2 border border-gray-300 rounded-md text-gray-700 dark:bg-gray-800 dark:text-gray-200 focus:border-blue-500 focus:outline-none"
                                    >
                                @error("nama_kaprog")
                                <p class="mt-2 text-sm text-red-800">
                            ...
                            <div class="mb-4 w-4/5">
                                ...
                                <input type="text" value="{{old("ket_kaprog",$animasi->ket_kaprog)}}" name="ket_kaprog" id="ket_kaprog"
                                    class="mt-1 shadow-md block w-full px-3 py-2 border border-gray-300 rounded-md text-gray-700 dark:bg-gray-800 dark:text-gray-200 focus:border-blue-500 focus:outline-none"
                                    >
                                @error("ket_kaprog")
                                <p class="mt-2 text-sm text-red-800">
                            ...
                            <img class="w-52  duration-700  rounded-md object-cover h-auto" src="{{ asset("img/jurusan/" . $animasi->photo_kaprog) }}" alt="">
                            @else
                            <p class="mt-3">photo_kaprog saat ini : </p>
