...
@section("content")
    <div id="main" class="main-content flex-1 bg-gray-100 md:pt-20 md:pl-6 md:mt-2">
        <x-title-create-dashboard class="lowercase">{{ $dkv->judul }}</x-title-create-dashboard>
        <div class="w-full">
            <form id="form" action="{{ route('dkv.update',[Crypt::encrypt($dkv->id)]) }}" class="mt-4 w-full flex flex-col" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex gap-2">
                        ...
                        <div class="w-1/2 gap-2 ">
                            <div class="mb-4 w-4/5">
                                ...
                                <input type="text" value="{{ $dkv->nama_kaprog }}" name="nama_kaprog" id="nama_kaprog"
                                    class="mt-1 shadow-md block w-full px-3 py-2 border border-gray-300 rounded-md text-gray-700 dark:bg-gray-800 dark:text-gray-200 focus:border-blue-500 focus:outline-none"
                                    >
                                @error("nama_kaprog")
                                <p class="mt-2 text-sm text-red-800">
                            ...
                            <div class="mb-4 w-4/5">
                                ...
                                <input type="text" value="{{old("ket_kaprog",$dkv->ket_kaprog)}}" name="ket_kaprog" id="ket_kaprog"
                                    class="mt-1 shadow-md block w-full px-3 py-2 border border-gray-300 rounded-md text-gray-700 dark:bg-gray-800 dark:text-gray-200 focus:border-blue-500 focus:outline-none"
                                    >
                                @error("ket_kaprog")
                                <p class="mt-2 text-sm text-red-800">
                            ...
                            <img class="w-52  duration-700  rounded-md object-cover h-auto" src="{{ asset("img/jurusan/" . $dkv->photo_kaprog) }}" alt="">
                            @else
                            <p class="mt-3">photo_kaprog saat ini : </p>
                ...
                <img class="w-1/5  duration-700  rounded-md object-cover h-full" src="{{ asset("img/jurusan/" . $dkv->photo) }}" alt="">
                @else
