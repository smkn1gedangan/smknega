...
@section("content")
    <div id="main" class="main-content flex-1">
       <x-titlepage title="data jurusan dkv" quote="ubah data jurusan dkv di smkn 1 gedangan " isRoute="true" nameRoute="Kembali" href="{{ route('dkv.index') }}"></x-titlepage>
        <div class="w-full p-5">
            <form id="form" action="{{ route('dkv.update',[Crypt::encrypt($dkv->id)]) }}" class="mt-4 w-full flex flex-col" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                    <div class="grid grid-cols-12 space-y-5 gap-2">
                        <div class="col-span-7 ">
                            <div>
                                ...
                                <x-text-input type="text" id="judul" class="block mt-1 w-full" name="judul" :value="old('judul',$dkv->judul)" required  />
                        ...
                        <div class="col-span-7">
                            <div>
                                ...
                                <x-text-input type="text" id="nama_kaprog" class="block mt-1 w-full" name="nama_kaprog" :value="old('nama_kaprog',$dkv->nama_kaprog)" required  />
                        ...
                        <div class="col-span-7">
                            <div>
                                ...
                                <x-text-input type="text" id="ket_kaprog" class="block mt-1 w-full" name="ket_kaprog" :value="old('ket_kaprog',$dkv->ket_kaprog)" required  />
                        ...
                        <div class="col-span-7">
                            <div>
                                ...
                                <x-text-input type="file" id="photo_kaprog" class="block border border-black mt-1 w-full" name="photo_kaprog" :value="old('photo_kaprog',$dkv->photo_kaprog)"  />
                                <x-input-error :messages="$errors->get('photo')" class="mt-2" />
                                @if (file_exists(public_path('storage/' . $dkv->photo_kaprog)) && $dkv->photo_kaprog)
                                <p class="mt-3">photo kaprog saat ini : </p>
                                <img class="w-72 h-auto" src="{{ asset("storage/" . $dkv->photo_kaprog) }}" alt="">
                                @else
                                <p class="mt-3">photo kaprog saat ini : </p>
                        ...
                        <div class="col-span-10">
                         ...
                         <div class="col-span-7">
                            <div>
                                ...
                                <x-text-input type="file" id="photo" class="block mt-1 w-full border border-black" name="photo" :value="old('photo',$dkv->photo)"/>
                                <x-input-error :messages="$errors->get('photo')" class="mt-2" />
                                @if (file_exists(public_path('storage/' . $dkv->photo)) && $dkv->photo)
                                <p class="mt-3">photo Jurusan: </p>
                                <img class="w-72 h-auto" src="{{ asset("storage/" . $dkv->photo) }}" alt="">
                                @else
                                <p class="mt-3">photo Jurusan: </p>
                                <div class="bg-gray-200 w-44 h-52 grid place-content-center">
                                <span>No Image</span> <!-- Pesan fallback -->
