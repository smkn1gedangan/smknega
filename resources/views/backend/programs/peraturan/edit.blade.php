...
@section("content")
    <div id="main" class="main-content flex-1 ">
        <x-titlepage title="data Peraturan Peraturan" quote="ubah data Peraturan Peraturan smkn 1 gedangan " isRoute="true" nameRoute="Back" href="{{ route('peraturan.index') }}"></x-titlepage>
