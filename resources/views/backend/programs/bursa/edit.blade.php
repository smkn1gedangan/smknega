...
@section("content")
    <div id="main" class="main-content flex-1 bg-gray-100 md:pt-20 md:pl-6 md:mt-2">
        <x-title-create-dashboard class="lowercase">edit data bursa kerja</x-title-create-dashboard>
        <div class="w-full">
            <form id="form" action="{{ route('bursa.update',[Crypt::encrypt($bursa->id)]) }}" class="mt-4 w-full flex flex-col" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
...
<script src="https://cdn.quilljs.com/1.3.6/quill.min.js"></script>
    <script>
      document.addEventListener("DOMContentLoaded", function() {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Berhasil update data bursa kerja!',
