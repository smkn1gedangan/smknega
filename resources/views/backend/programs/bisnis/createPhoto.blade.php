...
@section("content")
    <div id="main" class="main-content flex-1 ">
        <x-titlepage title="Photo Bisnis" quote="data photo bisnis yang ada di smkn 1 gedangan" isRoute="true" nameRoute="list photo" href="{{ route('bisnis.index') }}"></x-titlepage>
        <div class="w-full p-5">
            <form id="form" action="{{ route('bisnisPhoto.store')}}" class="mt-4 w-full flex flex-col" method="POST" enctype="multipart/form-data">
                @csrf
